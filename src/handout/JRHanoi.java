...
public class JRHanoi extends JFrame implements Runnable
{
     ...
     public JRHanoi()
     {
        	...
        	playGame.setFont(new Font("TimesRoman", Font.BOLD, 25));
            runDemo = new JButton("Run Demo");
            runDemo.setFont(new Font("TimesRoman", Font.BOLD, 25));
            ...
            for (int i = 0; i < 3; i++)
            {
                 ...
                 towerButtons[i].setFont(new Font("TimesRoman", Font.BOLD, 30));
			...
			info.setFont(new Font("TimesRoman", Font.BOLD, 25));
 ...
 // records and the run-time stack, as we discussed in lecture.
     ...
     {
            UIManager.put("OptionPane.messageFont", new Font("TimesRoman", Font.BOLD, 25));
			UIManager.put("OptionPane.buttonFont", new Font("TimesRoman", Font.PLAIN, 25));
			UIManager.put("TextField.font", new Font("TimesRoman", Font.PLAIN, 25));
     ...
     private class Tower
     {
         public final int MAXWIDTH = 240, HEIGHT = 40;
